        ...
        <form action="#!" method="POST" className="questions__form">
          <div className="questions__inner">
            <div className="custom-input">
              ...
              <input type="text" className="custom-input__field" id="name" placeholder="Светлана" required/>
            </div>
            <div className="custom-input">
              <label htmlFor="email" className="custon-input__label">Ваша почта</label>
              <input type="email" className="custom-input__field" id="email" placeholder="example@example.com" required/>
            </div>
            <button className="questions__btn btn btn--big" type="submit">Отправить заявку</button>
          </div>
          <div className="custom-checkbox">
            <input className="visually-hidden custom-checkbox__field" id="agree" type="checkbox" name="pendant"/>
