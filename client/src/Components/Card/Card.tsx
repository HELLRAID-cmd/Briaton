      ...
      <div className={`product-card ${className ?? "" }`} data-goods-of-day={goodsOfDay}>
        <div className="product-card__visual">
          ...
          <div className="product-card__more">
            ...
            <button className="product-card__link btn btn--secondary" type="button">Подробнее</button>
        ...
        <div className="product-card__info">
          ...
          <span className="product-card__old-number">{price.old.toLocaleString(
        "ru-Ru"
      )}</span>
          <span className="product-card__old-add">₽</span>
        </span>
          <span className="product-card__price">
          <span className="product-card__price-number">{price.new.toLocaleString(
        "ru-Ru"
      )}</span>
          <span className="product-card__price-add">₽</span>
        </span>
          <div className="product-card__tooltip tooltip">
            <button id="tooltip-btn" className="tooltip__btn" aria-label="Показать подсказку">
            ...
            <div className="tooltip__content">
              ...
              <ul className="tooltip__list">
                <li className="tooltip__item">
                  <span className="tooltip__text">Москва: <span className="tooltip__count">{availability.moscow}</span></span>
                </li>
                <li className="tooltip__item">
                  <span className="tooltip__text">Оренбург: <span className="tooltip__count">{availability.orenburg}</span></span>
                </li>
                <li className="tooltip__item">
                  <span className="tooltip__text">Санкт-Петербург: <span className="tooltip__count">{availability.saintPetersburg}</span></span>
                </li>
              </ul>
            </div>
          </div>
